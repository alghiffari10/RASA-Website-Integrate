...
class ExtractFoodEntity(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if food_entity:
            ...
            dispatcher.utter_message(text=f"I am sorry, I could not detect the food choice")
...
class OrderFoodAction(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        dispatcher.utter_message(text=f"Sure, what kind of food would like to order")
